     ...
     <div
         ...
         <div class="w-full md:w-auto">
             <button wire:click="generatePayroll"
                 wire:confirm="Proses penggajian untuk priode {{ $bulan }}/{{ $tahun }}? Pastikan semua data sudah benar. "
                    ...
                    @forelse ($penggajians as $gaji)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4">
                                ...
                                <div class="text-xs text-gray-500">{{ $gaji->karyawan->jabatan->nama ?? 'Tidak ada jabatan' }}</div>
                            </td>
